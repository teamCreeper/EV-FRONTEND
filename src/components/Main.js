        ...
        {loading ? (
          ...
          <>
            ...
            <CarSwiper
              logo={hyundailogo}
              brand='Hyundai'
              images={electricVehicles.filter((v) => v.brand === 'Hyundai')}
            />
            <CarSwiper
              logo={kialogo}
              brand='Kia'
              images={electricVehicles.filter((v) => v.brand === 'Kia')}
            />
            <CarSwiper
              logo={benzlogo}
              brand='Mercedes-Benz'
              images={electricVehicles.filter((v) => v.brand === 'Mercedes-Benz')}
            />
            <CarSwiper
              logo={bmwlogo}
              brand='BMW'
              images={electricVehicles.filter((v) => v.brand === 'BMW')}
            />
            <CarSwiper
              logo={audilogo}
              brand='Audi'
              images={electricVehicles.filter((v) => v.brand === 'Audi')}
            />
          </>
        )}
      </div>
